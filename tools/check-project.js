...
if (packageJson.version !== "8.1.0") throw new Error(`Unexpected package version ${packageJson.version}`);
if (!serverSource.includes('const GAME_VERSION = "8.1.0"')) throw new Error("Server version is not synchronized");
