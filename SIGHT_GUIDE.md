# Voxel Combat Arena v8.4 Sight Guide

Version 8.4 renders a dedicated camera-mounted weapon-and-arms viewmodel and uses the weapon model itself for ordinary aiming. The center of each sight is projected to the camera center and the weapon remains visible throughout the ADS transition.
