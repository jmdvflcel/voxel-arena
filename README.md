# Voxel Combat Arena v8

A server-authoritative browser arena shooter built with Node.js, WebSockets, and Three.js. Version 8 focuses on combat feel, movement mastery, networking stability, accessibility, repeatable deployment, and a complete multiplayer match loop while remaining practical on an AWS EC2 `t3.micro`.
