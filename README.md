# Voxel Combat Arena v8.7

A server-authoritative browser arena shooter built with Node.js, WebSockets, and Three.js. Version 8.6 preserves the v8.5 ADS and aim-truth work while fixing duplicate scoreboard rows, frozen ghost characters, and reconnect-state accumulation.
