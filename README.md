# Voxel Combat Arena v8.5

A server-authoritative browser arena shooter built with Node.js, WebSockets, and Three.js. Version 8.5 improves ADS visibility for every weapon and aligns authoritative hits and tracers with the camera-center sight ray.
