# Voxel Combat Arena v8.3

A server-authoritative browser arena shooter built with Node.js, WebSockets, and Three.js. Version 8.3 rebuilds first-person aiming around visible, weapon-mounted sights instead of generic screen zoom.
