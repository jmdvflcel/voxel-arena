...
export const WEAPON_INFO = {
  sword: { name: "Arc Blade", icon: "⚔", kind: "melee", automatic: false, localCooldown: 365, color: 0x8ce8ff, recoil: 0, fov: 76, scope: "none" },
  ...
  voidblade: { name: "Void Reaper", icon: "☠", kind: "melee", automatic: false, localCooldown: 500, color: 0xff35e8, recoil: 0, fov: 76, scope: "none", rare: true }
};
