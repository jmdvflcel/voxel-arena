export const QUALITY_PRESETS = {
  low: { pixelRatio: 0.68, shadows: false, shadowFps: 0, shadowMapSize: 512, particles: 90, decals: 24, shellCasings: 12, postFx: false, viewDistance: 82, antialias: false },
  medium: { pixelRatio: 1.0, shadows: true, shadowFps: 20, shadowMapSize: 1024, particles: 210, decals: 56, shellCasings: 28, postFx: true, viewDistance: 118, antialias: true },
  high: { pixelRatio: 1.35, shadows: true, shadowFps: 30, shadowMapSize: 2048, particles: 360, decals: 96, shellCasings: 48, postFx: true, viewDistance: 148, antialias: true },
  ultra: { pixelRatio: 1.65, shadows: true, shadowFps: 60, shadowMapSize: 3072, particles: 480, decals: 128, shellCasings: 64, postFx: true, viewDistance: 170, antialias: true }
};
...
export const WEAPON_INFO = {
  sword: { name: "Arc Blade", icon: "⚔", kind: "melee", automatic: false, localCooldown: 365, heavyCooldown: 760, color: 0x8ce8ff, recoil: 0, fov: 76, scope: "none", sight: "none", adsSpeed: 1 },
  pistol: { name: "Pulse Pistol", icon: "◈", kind: "gun", automatic: false, localCooldown: 280, color: 0x83ddff, recoil: 0.018, fov: 76, scope: "iron", sight: "pistol-notch", adsSpeed: 20, zoomLevels: [1.025] },
  smg: { name: "Viper SMG", icon: "▥", kind: "gun", automatic: true, localCooldown: 68, color: 0x72ffc5, recoil: 0.011, fov: 74, scope: "iron", sight: "smg-aperture", adsSpeed: 21, zoomLevels: [1.055] },
  rifle: { name: "Vector Rifle", icon: "▰", kind: "gun", automatic: true, localCooldown: 94, color: 0xffcf70, recoil: 0.014, fov: 70, scope: "reflex", sight: "rifle-holo", adsSpeed: 17, zoomLevels: [1.10] },
  burst: { name: "Trident Burst", icon: "≋", kind: "gun", automatic: false, localCooldown: 390, color: 0x9aa7ff, recoil: 0.025, fov: 58, scope: "optic", sight: "burst-prism", adsSpeed: 14, zoomLevels: [1.22, 1.55] },
  shotgun: { name: "Scatter Cannon", icon: "◆", kind: "gun", automatic: false, localCooldown: 820, color: 0xff8d65, recoil: 0.052, fov: 75, scope: "iron", sight: "shotgun-bead", adsSpeed: 14, zoomLevels: [1.03] },
  lmg: { name: "Titan LMG", icon: "▣", kind: "gun", automatic: true, localCooldown: 118, color: 0xffb35f, recoil: 0.022, fov: 68, scope: "reflex", sight: "lmg-reflex", adsSpeed: 12, zoomLevels: [1.10] },
  marksman: { name: "Longshot", icon: "✦", kind: "gun", automatic: false, localCooldown: 900, color: 0xe8a5ff, recoil: 0.038, fov: 31, scope: "sniper", sight: "marksman-scope", adsSpeed: 9, zoomLevels: [2.25, 3.5, 5.0], breathDrain: 24 },
  railgun: { name: "Apex Railgun", icon: "⌁", kind: "gun", automatic: false, localCooldown: 1450, color: 0x65f3ff, recoil: 0.065, fov: 24, scope: "rail", sight: "rail-digital", adsSpeed: 7.5, zoomLevels: [2.6, 4.25, 6.5], breathDrain: 30 },
  voidblade: { name: "Void Reaper", icon: "☠", kind: "melee", automatic: false, localCooldown: 500, heavyCooldown: 900, color: 0xff35e8, recoil: 0, fov: 76, scope: "none", sight: "none", rare: true, adsSpeed: 1 }
};
...
export const WEAPON_PRESENTATION = Object.freeze({
  ...
  pistol: { reloadStyle: "pistol", scale: 0.82, kick: 0.72, adsZ: -0.50, adsYOffset: 0.004, rightGrip: [0.25, -0.29, -0.39], leftGrip: [-0.08, -0.31, -0.44] },
  smg: { reloadStyle: "magazine", scale: 0.75, kick: 0.62, adsZ: -0.58, adsYOffset: 0.002, rightGrip: [0.31, -0.29, -0.43], leftGrip: [-0.22, -0.27, -0.56] },
  rifle: { reloadStyle: "rifle", scale: 0.74, kick: 0.74, adsZ: -0.63, adsYOffset: 0, rightGrip: [0.31, -0.29, -0.43], leftGrip: [-0.24, -0.27, -0.60] },
  burst: { reloadStyle: "rifle", scale: 0.73, kick: 0.82, adsZ: -0.67, adsYOffset: 0, rightGrip: [0.31, -0.29, -0.43], leftGrip: [-0.24, -0.27, -0.61] },
  shotgun: { reloadStyle: "shotgun", scale: 0.70, kick: 1.18, adsZ: -0.66, adsYOffset: 0.003, rightGrip: [0.32, -0.31, -0.45], leftGrip: [-0.25, -0.29, -0.66] },
  lmg: { reloadStyle: "lmg", scale: 0.63, kick: 0.98, adsZ: -0.72, adsYOffset: 0, rightGrip: [0.34, -0.32, -0.46], leftGrip: [-0.27, -0.29, -0.63] },
  marksman: { reloadStyle: "marksman", scale: 0.68, kick: 1.12, adsZ: -0.78, adsYOffset: 0, rightGrip: [0.31, -0.30, -0.45], leftGrip: [-0.25, -0.28, -0.66] },
  railgun: { reloadStyle: "cell", scale: 0.62, kick: 1.45, adsZ: -0.82, adsYOffset: 0, rightGrip: [0.34, -0.33, -0.47], leftGrip: [-0.28, -0.30, -0.66] }
});
