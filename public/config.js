...
export const WEAPON_INFO = {
  ...
  pistol: { name: "Pulse Pistol", icon: "◈", kind: "gun", automatic: false, localCooldown: 280, color: 0x83ddff, recoil: 0.018, fov: 74, scope: "iron", adsSpeed: 20, zoomLevels: [1.06] },
  smg: { name: "Viper SMG", icon: "▥", kind: "gun", automatic: true, localCooldown: 68, color: 0x72ffc5, recoil: 0.011, fov: 72, scope: "iron", adsSpeed: 21, zoomLevels: [1.08] },
  rifle: { name: "Vector Rifle", icon: "▰", kind: "gun", automatic: true, localCooldown: 94, color: 0xffcf70, recoil: 0.014, fov: 66, scope: "reflex", adsSpeed: 17, zoomLevels: [1.18] },
  burst: { name: "Trident Burst", icon: "≋", kind: "gun", automatic: false, localCooldown: 390, color: 0x9aa7ff, recoil: 0.025, fov: 52, scope: "optic", adsSpeed: 14, zoomLevels: [1.5, 2.0] },
  shotgun: { name: "Scatter Cannon", icon: "◆", kind: "gun", automatic: false, localCooldown: 820, color: 0xff8d65, recoil: 0.052, fov: 72, scope: "iron", adsSpeed: 14, zoomLevels: [1.08] },
  lmg: { name: "Titan LMG", icon: "▣", kind: "gun", automatic: true, localCooldown: 118, color: 0xffb35f, recoil: 0.022, fov: 65, scope: "reflex", adsSpeed: 12, zoomLevels: [1.2] },
