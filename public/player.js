...
const FP_VIEWMODEL_POSES = Object.freeze({
  ...
  smg: {
    ...
    adsDepth: -0.88, adsOffset: [0, 0.001], adsRotation: [0, 0, 0], armSpread: 0.038
  },
  rifle: {
    hipPosition: [0.43, -0.43, -0.86], hipRotation: [-0.07, -0.12, 0.016],
    adsDepth: -0.98, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.042
  },
  burst: {
    hipPosition: [0.42, -0.43, -0.87], hipRotation: [-0.06, -0.115, 0.01],
    adsDepth: -1.10, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.042
  },
  shotgun: {
    hipPosition: [0.47, -0.47, -0.92], hipRotation: [-0.09, -0.14, 0.028],
    adsDepth: -1.04, adsOffset: [0, 0.002], adsRotation: [0, 0, 0], armSpread: 0.048
  },
  lmg: {
    hipPosition: [0.49, -0.50, -0.96], hipRotation: [-0.10, -0.15, 0.035],
    adsDepth: -1.18, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.052
  },
  marksman: {
    hipPosition: [0.44, -0.44, -0.92], hipRotation: [-0.065, -0.115, 0.012],
    adsDepth: -1.24, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.042
  },
  railgun: {
    hipPosition: [0.48, -0.49, -0.98], hipRotation: [-0.11, -0.16, 0.04],
    adsDepth: -1.32, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.054
  }
});
...
export class FirstPersonWeapon {
  ...
  update(dt, movementSpeed, grounded, aiming) {
    ...
    const fullScope = (this.current === "marksman" || this.current === "railgun") && this.targetAim > 0.5 && this.aim > 0.82;
