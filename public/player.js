...
const FP_VIEWMODEL_POSES = Object.freeze({
  pistol: {
    ...
    adsDepth: -0.50, adsOffset: [0, 0.004], adsRotation: [0, 0, 0], armSpread: 0.032
  },
  smg: {
    hipPosition: [0.39, -0.41, -0.80], hipRotation: [-0.055, -0.13, 0.02],
    adsDepth: -0.58, adsOffset: [0, 0.002], adsRotation: [0, 0, 0], armSpread: 0.04
  },
  rifle: {
    hipPosition: [0.43, -0.43, -0.86], hipRotation: [-0.07, -0.12, 0.016],
    adsDepth: -0.63, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.045
  },
  burst: {
    hipPosition: [0.42, -0.43, -0.87], hipRotation: [-0.06, -0.115, 0.01],
    adsDepth: -0.68, adsOffset: [0, -0.002], adsRotation: [0, 0, 0], armSpread: 0.044
  },
  shotgun: {
    hipPosition: [0.47, -0.47, -0.92], hipRotation: [-0.09, -0.14, 0.028],
    adsDepth: -0.66, adsOffset: [0, 0.003], adsRotation: [0, 0, 0], armSpread: 0.05
  },
  lmg: {
    hipPosition: [0.49, -0.50, -0.96], hipRotation: [-0.10, -0.15, 0.035],
    adsDepth: -0.73, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.056
  },
  marksman: {
    hipPosition: [0.44, -0.44, -0.92], hipRotation: [-0.065, -0.115, 0.012],
    adsDepth: -0.80, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.045
  },
  railgun: {
    hipPosition: [0.48, -0.49, -0.98], hipRotation: [-0.11, -0.16, 0.04],
    adsDepth: -0.84, adsOffset: [0, 0], adsRotation: [0, 0, 0], armSpread: 0.06
  }
});
