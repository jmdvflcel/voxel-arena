...
function buildRifle(group, m, burst = false) {
  ...
  addOptic(group, -0.26, burst ? 0.48 : 0.42, m, burst);
...
function buildShotgun(group, m) {
  ...
  addOptic(group, -0.2, 0.24, m, false);
...
function buildFallbackGun(group, name, m) {
  ...
  addOptic(group, -0.2, 0.32, m, false);
...
function applyRemotePose(actor, state, now, dt) {
  ...
  let rightShoulderX = sword ? -0.7 : -1.2 + aimPitch * 0.7;
  let leftShoulderX = sword ? -0.28 : -1.05 + aimPitch * 0.65;
  let rightShoulderZ = sword ? -0.18 : 0.08;
  let leftShoulderZ = sword ? 0.24 : -0.22;
  let rightElbow = sword ? -0.16 : -0.58;
  let leftElbow = sword ? -0.24 : -0.72;
  ...
  if (actor.swing > 0 && sword) {
    ...
    rightShoulderX = -0.72;
    rightShoulderZ = -0.62;
    leftShoulderX = -0.38 + reloadWave * 0.12;
    leftShoulderZ = 0.48;
    rightElbow = -1.0;
    leftElbow = -1.22;
...
const FP_AIM_LAYOUTS = Object.freeze({
  pistol: [0, -0.278, -0.55], smg: [0, -0.29, -0.6], rifle: [0, -0.305, -0.63],
  burst: [0, -0.305, -0.63], shotgun: [0, -0.32, -0.66], lmg: [0, -0.325, -0.68],
  marksman: [0, -0.34, -0.72], railgun: [0, -0.35, -0.75]
});
