...
function addPrismSight(group, z, materials) {
  ...
  const halfHeight = 0.135;
  const frameDepth = 0.34;
  box(sight, [0.035, halfHeight * 2, frameDepth], [-halfWidth, 0, 0], materials.secondary, "prismFrameLeft");
  box(sight, [0.035, halfHeight * 2, frameDepth], [halfWidth, 0, 0], materials.secondary, "prismFrameRight");
  box(sight, [halfWidth * 2 + 0.035, 0.035, frameDepth], [0, halfHeight, 0], materials.secondary, "prismFrameTop");
  box(sight, [halfWidth * 2 + 0.035, 0.035, frameDepth], [0, -halfHeight, 0], materials.secondary, "prismFrameBottom");
  box(sight, [0.31, 0.235, 0.012], [0, 0, 0.19], materials.glass, "prismRearGlass");
  box(sight, [0.13, 0.04, 0.12], [0, -0.18, 0], materials.primary, "prismMount");
...
export class FirstPersonWeapon {
  ...
  update(dt, movementSpeed, grounded, aiming) {
    ...
    const fullScopeBlend = scopedPrecisionWeapon ? THREE.MathUtils.smoothstep(this.aim, 0.48, 0.76) : 0;
    const fullScope = scopedPrecisionWeapon && this.targetAim > 0.35 && fullScopeBlend > 0.55;
    model.visible = !fullScope;
    this.leftArm.visible = !fullScope;
    this.rightArm.visible = !fullScope;
