# Upgrade to Voxel Combat Arena v8.3
...
The update script stages and validates the new release before swapping it into `/opt/voxel-arena`. Version 8.3 adds unique, weapon-mounted ADS geometry and per-weapon camera alignment.
