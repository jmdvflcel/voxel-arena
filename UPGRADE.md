# Upgrade to Voxel Combat Arena v8.4
...
The update script stages and validates the new release before swapping it into `/opt/voxel-arena`. Version 8.4 fixes camera-mounted viewmodel rendering, keeps hands and weapons visible, and adds unique per-weapon hip/ADS poses.
