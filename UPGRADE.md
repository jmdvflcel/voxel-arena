# Upgrade to Voxel Combat Arena v8.5
...
The update script stages and validates the new release before swapping it into `/opt/voxel-arena`. Version 8.5 adds clearer per-weapon ADS, unobstructed true scopes, faded central labels, and camera-aligned authoritative hit rays.
