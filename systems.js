...
export const WEAPON_INFO = {
  ...
  pistol: { name: "Pulse Pistol", icon: "◈", kind: "gun", automatic: false, localCooldown: 280, color: 0x83ddff, recoil: 0.018, fov: 76, scope: "iron", sight: "pistol-notch", adsSpeed: 20, zoomLevels: [1.03] },
  smg: { name: "Viper SMG", icon: "▥", kind: "gun", automatic: true, localCooldown: 68, color: 0x72ffc5, recoil: 0.011, fov: 74, scope: "iron", sight: "smg-aperture", adsSpeed: 21, zoomLevels: [1.06] },
  rifle: { name: "Vector Rifle", icon: "▰", kind: "gun", automatic: true, localCooldown: 94, color: 0xffcf70, recoil: 0.014, fov: 70, scope: "reflex", sight: "rifle-holo", adsSpeed: 17, zoomLevels: [1.12] },
  burst: { name: "Trident Burst", icon: "≋", kind: "gun", automatic: false, localCooldown: 390, color: 0x9aa7ff, recoil: 0.025, fov: 58, scope: "optic", sight: "burst-prism", adsSpeed: 14, zoomLevels: [1.35, 1.75] },
  shotgun: { name: "Scatter Cannon", icon: "◆", kind: "gun", automatic: false, localCooldown: 820, color: 0xff8d65, recoil: 0.052, fov: 75, scope: "iron", sight: "shotgun-bead", adsSpeed: 14, zoomLevels: [1.04] },
  lmg: { name: "Titan LMG", icon: "▣", kind: "gun", automatic: true, localCooldown: 118, color: 0xffb35f, recoil: 0.022, fov: 68, scope: "reflex", sight: "lmg-reflex", adsSpeed: 12, zoomLevels: [1.14] },
  marksman: { name: "Longshot", icon: "✦", kind: "gun", automatic: false, localCooldown: 900, color: 0xe8a5ff, recoil: 0.038, fov: 31, scope: "sniper", sight: "marksman-scope", adsSpeed: 9, zoomLevels: [2.5, 4.0, 6.0], breathDrain: 24 },
  railgun: { name: "Apex Railgun", icon: "⌁", kind: "gun", automatic: false, localCooldown: 1450, color: 0x65f3ff, recoil: 0.065, fov: 24, scope: "rail", sight: "rail-digital", adsSpeed: 7.5, zoomLevels: [3.0, 5.0, 8.0], breathDrain: 30 },
